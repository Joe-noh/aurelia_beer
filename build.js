...
System.register("dist/beers-api", ["aurelia-http-client"], function(_export) {
  "use strict";
  var HttpClient,
      _prototypeProperties,
      _classCallCheck,
  ...
  return {
    ...
    execute: function() {
      ...
      BeersApi = _export("BeersApi", (function() {
        ...
        _prototypeProperties(BeersApi, {inject: {
            value: function inject() {
              return [HttpClient];
            },
            writable: true,
...
System.register("dist/app", ["aurelia-router", "./beers-api"], function(_export) {
  "use strict";
  var Router,
      BeersApi,
      _prototypeProperties,
